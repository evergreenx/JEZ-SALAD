...
export default function Footer() {
  return (
<footer class="text-center lg:mx-16 lg:text-left bg-white text-gray-600 mx-auto">
...
high nutrition.
      ...
      <p class="text-gray-500 text-sm">
        &copy; {new Date().getFullYear()} Jez Salad. All rights reserved.
      </p>

      </div>
      <div class="">
        <h6 class=" text-primary  font-semibold mb-4 flex justify-center md:justify-start">
        Feature
        </h6>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Menu</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Promo</a>
        </p>
        <p class="mb-4">
